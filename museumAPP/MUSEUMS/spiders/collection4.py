...
class Collection75Spider(scrapy.Spider):
    ...
    def parse_detail(self,response):
        ...
        #http://www.jb.mil.cn/gcww/wwjs_new/shzysq/201707/t20170705_32875.html

        #这两行代码是我测试<p>能不能被找到
        data=response.xpath("//div[@class='interaction']/div[@class='interContext']/div[@class='TRS_Editor']/p[last()-1]/text()").extract_first()
        print(data)
        item['collectionIntroduction']=data
        yield item
